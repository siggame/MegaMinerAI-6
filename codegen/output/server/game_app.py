...
class GameApp(AccountsAppMixin, BaseApp):
  ...
  def gameMove(self, superman, x, y):
    """"""
    return self.game.move(superman, x, y)

  @protocolmethod
  @errorBuffer
  @requireTurn
  @requireTypes(None, int, int)
  def gameAttack(self, superman, target):
    """"""
    return self.game.attack(superman, target)

  @protocolmethod
  @errorBuffer
  @requireTurn
  @requireTypes(None, int, int, int, int, int, int)
  def gameHatch(self, tube, damage, reach, speed, health, view):
    """"""
    return self.game.hatch(tube, damage, reach, speed, health, view)
